...
import Card1 from "./organizma/Card1"
import Card2 from "./organizma/Card2"
import Card3 from "./organizma/Card3"
import Card4 from "./organizma/Card4"
    ...
    <div className="landingpage">
      <div className="navbarcss">
        <ul className="nav justify-content-center nav-underline">
          ...
          <li className="nav-item">
            <a className="nav-link me-5" href="/login-demo" style={{ color: 'white', fontSize: 30 }}>Login</a>
          </li>
        </ul>
      </div>
